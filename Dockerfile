...
# Install OpenJDK
RUN curl -L -o /tmp/openjdk.tar.gz https://github.com/AdoptOpenJDK/openjdk11-upstream-binaries/releases/download/jdk-11.0.1%2B13/OpenJDK11U-aarch64_linux_hotspot_11.0.1_13.tar.gz \
